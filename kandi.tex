...
\texttt{maisema}: joukko valonlähteitä ja polygoneihin jaettuja objekteja}
...
\ForEach{pikseli $(x,y) \; \epsilon$ \textnormal{\texttt{kuvataso}}}{
  ...
  \ForEach{polygoni $\epsilon$ \textnormal{\texttt{maisema}}}{
    Ammu säde $\vec{R}=O+t\vec{D}$ kamerasta pikselin läpi \textnormal{\texttt{maisema}}an \\
    \eIf{säde $R$ osui polygoniin pisteessä $P$ {\bf and} t < \textnormal{\texttt{etaisyys}}}{
