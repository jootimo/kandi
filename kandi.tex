...
%﻿\documentclass[a4paper,12pt, titlepage]{article} % siis mikä tässä nyt on ettei toimi?!
...
\begin{figure}
 \centering 
 \includegraphics[width=0.6\textwidth]{img/bsp3.png}
 \vspace{0.4cm}
...
Objektin $O$ ympäröivä tila on jokin yksinkertainen kolmiulotteinen objekti $V$, jolle $O \cap V \equiv O$ \citep{havran}.
